...
public class FinancialForecasting {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Recursive Forecast after %d years: %s%n", years, formatCurrency(recursiveResult));
        System.out.printf("Iterative Forecast after %d years: %s%n", years, formatCurrency(iterativeResult));
